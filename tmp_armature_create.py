...
class TMP_create:
	...
	def __init__(self):
		...
		('FRTMP_open_smile_R', (-0.107, self.y, 1.14), (-0.107, self.y, 1.174), 'FRTMP_root'),
		('FRTMP_open_smile_L', (0.107, self.y, 1.14), (0.107, self.y, 1.174), 'FRTMP_root'),
		('FRTMP_dimpler_R', (-0.125, self.y, 1.14), (-0.125, self.y, 1.174), 'FRTMP_root'),
		('FRTMP_dimpler_L', (0.125, self.y, 1.14), (0.125, self.y, 1.174), 'FRTMP_root'),
		...
		('FRTMP_lip_up_roll_R', (-0.186, self.y, 1.15), (-0.186, self.y, 1.17), 'FRTMP_root'),
		('FRTMP_lip_up_roll_M', (-0.171, self.y, 1.15), (-0.171, self.y, 1.17), 'FRTMP_root'),
		('FRTMP_lip_up_roll_L', (-0.156, self.y, 1.15), (-0.156, self.y, 1.17), 'FRTMP_root'),
		('FRTMP_lip_low_roll_R', (-0.186, self.y, 1.12), (-0.186, self.y, 1.14), 'FRTMP_root'),
		('FRTMP_lip_low_roll_M', (-0.171, self.y, 1.12), (-0.171, self.y, 1.14), 'FRTMP_root'),
		('FRTMP_lip_low_roll_L', (-0.156, self.y, 1.12), (-0.156, self.y, 1.14), 'FRTMP_root'),
		('FRTMP_lips_pinch_R', (0.120, self.y, 1.105), (0.120, self.y, 1.125), 'FRTMP_root'),
		('FRTMP_lips_pinch_L', (0.135, self.y, 1.105), (0.135, self.y, 1.125), 'FRTMP_root'),
		...
		('FRTMP_lid_squint_R', (-0.128, self.y, 1.222), (-0.128, self.y, 1.255), 'FRTMP_root'),
		('FRTMP_lid_squint_L', (0.128, self.y, 1.222), (0.128, self.y, 1.255), 'FRTMP_root'),
		...
		('FRTMP_chin_wrinkle', (0.0, self.y, 1.098), (0.0, self.y, 1.126), 'FRTMP_root'),
		]
		
		self.sp_bones_list = [
		('FRTMP_lips', (0.47, self.y, 1.12), (0.47, self.y, 1.194), 'FRTMP_root'),
		('FRTMP_open_smile', (0.541, self.y, 1.12), (0.541, self.y, 1.194), 'FRTMP_root'),
		('FRTMP_dimpler', (0.574, self.y, 1.12), (0.574, self.y, 1.194), 'FRTMP_root'),
		('FRTMP_cheeks', (0.326, self.y, 1.12), (0.326, self.y, 1.194), 'FRTMP_root'),
		('FRTMP_lid_squint', (0.4, self.y, 1.12), (0.4, self.y, 1.194), 'FRTMP_root'),
		#('FRTMP_jaw_back_fwd', (0.389, self.y, 1.025), (0.389, self.y, 1.099), 'FRTMP_root'),
		('FRTMP_back_fwd_chew', (0.389, self.y, 1.099), (0.389, self.y, 1.025), 'FRTMP_root'),
		('FRTMP_funnel', (0.314, self.y, 1.025), (0.314, self.y, 1.099), 'FRTMP_root'),
		...
		#mouth_stretch
		('FRTMP_mouth_stretch', (0.458, self.y, 0.987), (0.542, self.y, 0.987), 'FRTMP_root'),
		]
